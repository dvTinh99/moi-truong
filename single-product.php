                                    ...
                                    <div id="content" role="main">
                                        <nav class="woocommerce-breadcrumb">
                                            <a href="https://baoholaodongdanang.com">Trang
                                                ...
                                                bảo hộ</a>&nbsp;/&nbsp;Mũ bảo hộ COV Hàn Quốc</nav>
                                                ...
                                                <figure class="woocommerce-product-gallery__wrapper">
                                                    <div data-thumb="" class="woocommerce-product-gallery__image m-zoomin">
                                                        <a href="<?= get_the_post_thumbnail_url(get_the_ID(), 'thumnail', array( 'class' =>'thumnail') ) ?>" class="img2">
                                                            <img width="180" 
                                                            height="151" 
                                                            src="<?= get_the_post_thumbnail_url(get_the_ID(), 'thumnail', array( 'class' =>'thumnail') ); ?>" 
                                                            class="attachment-shop_single size-shop_single wp-post-image" 
                                                            alt="mu-bao-ho-cov-han-quoc" 
                                                            title="" 
                                                            data-src="<?= get_the_post_thumbnail_url(get_the_ID(), 'thumnail', array( 'class' =>'thumnail') ); ?>" 
                                                            data-large_image="<?= get_the_post_thumbnail_url(get_the_ID(), 'thumnail', array( 'class' =>'thumnail') ); ?>" 
                                                            data-large_image_width="429" 
                                                            data-large_image_height="361" 
                                                            srcset="<?= get_the_post_thumbnail_url(get_the_ID(), 'thumnail', array( 'class' =>'thumnail') );?>" 
